...
enum led_brightness backlight_default_level = LED_HALF;//LED_FULL;
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	{"lcd-backlight",	  MT65XX_LED_MODE_CUST_LCM, (int)disp_bls_set_backlight,{0}},// MT65XX_LED_MODE_CUST_LCM MT65XX_LED_MODE_CUST_BLS_PWM
};
