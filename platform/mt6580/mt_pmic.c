...
#ifdef MT6580_USE_FCHR_ENB_KEY	
    ret = pmic_config_interface(0x40,0x0,0x1,0); 
    ret = pmic_config_interface(0x40,0x0,0x1,1); 
    ret = pmic_config_interface(0x40,0x1,0x1,2); 
    ret = pmic_config_interface(0x16c,0x1,0x1,3); 
#endif		
}
