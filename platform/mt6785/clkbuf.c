...
#define ENBB_CTRL_MASK		(0x3)
#define ENBB_CTRL_SHIFT		(13)

void clk_buf_disp_ctrl(bool onoff, bool force_on_o0)
{
	unsigned int dcxo_enable = DRV_Reg32(DCXO_ENABLE) & (~DCXO_NFC_ENABLE);

	DRV_WriteReg32(DCXO_ENABLE, dcxo_enable);
