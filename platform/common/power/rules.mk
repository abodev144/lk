...
ifeq ($(MTK_MT6360_PMU_CHARGER_SUPPORT),yes)
	...
	DEFINES += SWCHR_POWER_PATH
	DEFINES += PMU_CHARGER_GET_VBUS
endif

ifeq ($(MTK_MT6362_PMU_CHARGER_SUPPORT),yes)
	OBJS += $(LOCAL_DIR)/mt6362_pmu_charger.o
	DEFINES += MTK_MT6362_PMU_CHARGER_SUPPORT
	DEFINES += SWCHR_POWER_PATH
	DEFINES += PMU_CHARGER_GET_VBUS
endif
...
ifeq ($(MTK_FAN5405_CHARGER_SUPPORT),yes)
	OBJS +=$(LOCAL_DIR)/fan5405.o
	DEFINES += MTK_FAN5405_CHARGER_SUPPORT
endif
