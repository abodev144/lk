...
{	
        ...
        params->dsi.PLL_CLOCK = 220;//185;//183 212 195 200 205 180 230
...
LCM_DRIVER ili9881d_hdplus_vdo_haifei_lcm_drv = 
{
    .name			= "ili9881d_hdplus_vdo_haifei",
