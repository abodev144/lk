...
{0xC5,1,{0xb0}},
{0x00,1,{0x90}},
{0xC5,5,{0x4e,0x2B,0x04,0x7B,0x33}},
{0x00,1,{0x00}},
{0xD8,2,{0x70,0x70}},
{0x00,1,{0x00}},
{0xD9,1,{0x59}},//5B
...
{0xCC,5,{0x00,0x00,0x00,0x00,0x00}},
{0x00,1,{0xD0}},
{0xCC,10,{0x00,0x00,0x00,0x00,0x00,0x26,0x01,0x0D,0x0F,0x25,0x00}},
{0x00,1,{0x00}},
{0xE1,20,{0x00,0x2f,0x3f,0x4c,0x5c,0x68,0x69,0x8f,0x7d,0x95,0x70,0x5c,0x71,0x50,0x4d,0x40,0x35,0x25,0x1c,0x04}},
{0x00,1,{0x00}},
{0xE2,20,{0x00,0x2f,0x3f,0x4c,0x5b,0x68,0x69,0x8f,0x7d,0x95,0x70,0x5c,0x71,0x50,0x4d,0x40,0x34,0x25,0x1c,0x04}},
{0x00,1,{0x80}},
{0xC4,1,{0x30}},	
{0x00,1,{0x98}},
{0xC0,1,{0x00}},	//
...
static int adc_read_vol(int channel)
{
        ...
        adc_vol = sum/10;
#if defined(BUILD_LK)
        printf(" lk -22-- sunritel test channel= %d, adc_vol is %d\n",channel,adc_vol);
#else
        printk(" kernel -22-- sunritel test adc_vol is %d\n",adc_vol);
#endif
...
static unsigned int lcm_compare_id(void)
{
	...
	id2_adc = adc_read_vol(12);
  	...
  	printf("22---id1_adc=%d, id2_adc=%d--- \n",id1_adc,id2_adc);
	
    return ((id==LCM_ID_OTM8019A)&& ((id1_adc == 0)&& (id2_adc == 1)))?1:0;
		
}

LCM_DRIVER otm8019a_fwvga_dsi_vdo_boe_qicai_lcm_drv = 
{
    .name = "otm8019a_fwvga_dsi_vdo_boe_qicai",
