...
static int _lcm_i2c_write_bytes(kal_uint8 addr, kal_uint8 value)
{
	...
	if (lcm_util_get_i2c_lcd_bias(&id, &i2c_addr) < 0)
		return -1;
	lcd_bias_i2c.id = (U16)id;
	lcd_bias_i2c.addr = (U16)i2c_addr;
	lcd_bias_i2c.mode = LCM_I2C_MODE;
	lcd_bias_i2c.speed = LCM_I2C_SPEED;
	len = 2;

	ret_code = i2c_write(&lcd_bias_i2c, write_data, len);
	if (ret_code<0)
...
LCM_DRIVER nt36672c_fhdp_dsi_vdo_auo_cphy_90hz_rt4801 = {
	.name = "nt36672c_fhdp_dsi_vdo_auo_cphy_90hz_rt4801",
