...
{0xB1,16,{0x7F,0x10,0x10,0x32,0x92,0x90,0x10,0xFA,0x58,0x80,0x20,0x20,0xF8,0xAA,0xAA,0xA3,0x00,0x80,0x30,0x00}},  
...
//	id = buffer[0];
	...
	printf("yxch longli read id pin value = %d\n",hw_id);
