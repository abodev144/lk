...
#define LCD_MODUL_ID1 (GPIO4|0x80000000)
#define LCD_MODUL_ID2 (GPIO94|0x80000000)
...
static unsigned int lcm_compare_id(void)
{
	...
	id1_adc = mt_get_gpio_in(LCD_MODUL_ID1);
	id2_adc = mt_get_gpio_in(LCD_MODUL_ID2);
  	printf("huchangyu---id1_adc=%d, id2_adc=%d--- \n",id1_adc,id2_adc);
	printf("---id=0x%x--- \n",id);
    //return ((id==LCM_ID_OTM8019A)&& ((id1_adc == 0)&& (id2_adc == 1)))?1:0;
	return ((id==LCM_ID_OTM8019A) && (id2_adc ==0))?1:0;	
}

LCM_DRIVER otm8019a_fwvgaplus_dsi_vdo_boe_huchangyu_lcm_drv = 
{
